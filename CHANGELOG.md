...
- Image support in documentation with automatic loading via API
- Screenshot component with browser frame styling (macOS-style traffic lights, URL bar)
- Scrollable screenshots with configurable height
- Aspect ratio support for screenshots
- Language-independent image fallback (images in `docs/{set}/images/` work for all locales)
